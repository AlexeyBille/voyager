...
return [
    ...
    'database' => [
        ...
        'relationship'              => [
            'relationship'         => 'Отношение (Relationship)',
            'relationships'        => 'Отношения (Relationships)',
            'has_one'              => 'Имеет одни (Has One)',
            'has_many'             => 'Имеет много (Has Many)',
            'belongs_to'           => 'Принадлежит (Belongs To)',
            'belongs_to_many'      => 'Принадлежит многим (Belongs To Many)',
            'which_column_from'    => 'Какой столбец из',
            'is_used_to_reference' => 'используется для отношения (Relationship)',
            'pivot_table'          => 'Сводная таблица (Pivot Table)',
            'selection_details'    => 'Информация о выборке',
            'display_the'          => 'Показывать',
            'store_the'            => 'Хранить',
            'easy_there'           => 'Easy there Captain',
            'before_create'        => 'Прежде чем создать новые отношение, вам нужно сначала создать BREAD<br> Затем вернитесь назад к редактированию BREAD\'а, и вы сможете добавить отношения. Спасибо',
            'cancel'               => 'Отмена',
            'add_new'              => 'Создать новое отношение (Relationship)',
            'open'                 => 'Открыть',
            'close'                => 'Закрыть',
            'relationship_details' => 'Описание отношения (Relationship)',
            'browse'               => 'Смотреть (Browse)',
            'read'                 => 'Читать (Read)',
            'edit'                 => 'Изменять (Edit)',
            'add'                  => 'Добавлять (Add)',
            'delete'               => 'Удалять (Delete)',
            'create'               => 'Создать отношение (Relationship)',
            'namespace'            => 'Пространство имен модели (Model Namespace) (например App\Category)',
        ],
    ],
